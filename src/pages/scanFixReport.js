...
import {submit_admin} from '../data/urls';
...
export default function ScanFixEntry () {
  ...
  const MEMO_MAX = 50;
  // const url = submit_admin; // 'manager'
  ...
  return (
    <Wrapper className="page-scan-ifix" title="我要报修">
      ...
      <div className="form-input bottom-up">
        <div className="input-wrapper"><label>联系人</label><Input value={name} onChange={e => setName(e.target.value)} placeholder="请输入联系人姓名" className="input"/></div>
        <div className="input-wrapper"><label>联系电话</label><Input value={phone} onChange={e => setPhone(e.target.value)} placeholder="请输入联系人手机号" className="input" type="number"/></div>
        <div className="input-wrapper"><label>详细地址</label><Input value={address} onChange={e => setAddress(e.target.value)} placeholder="请输入联系人地址" className="input" /></div>
      </div>

      <Button className="confirm" onClick={finish} disabled={openInform}>提交</Button>
      {openInform && <Inform close={closeInform} 
                          ...
                          data={{
                            ...
                            contact: name,            // 联系人姓名
                            mobile: phone,            // 联系人手机
                            address: address          // 联系人地址
                          }}
                      />}
    </Wrapper>
  )
}
//"http://kxp33.cnduomi.com/upload/default/20210312/90f27095b2065046f13c787620091b14.jpg,http://kxp33.cnduomi.com/upload/default/20210311/c6637f4205b3af475a0cc17ebc025d9c.jpeg,http://kxp33.cnduomi.com/upload/default/20210311/91a0522fb5fefa9e4aba0c0f72f6381d.jpg"